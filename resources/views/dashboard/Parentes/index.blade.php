    ...
    <!------card---->
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('dashboard.parents.create') }}" class="btn btn-secondary btn-rounded float-right"><i class="fa fa-plus"></i> Add Parent</a>
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <div class="d-inline-flex">
                                            <form action="{{ route('dashboard.parents.destroy',$user->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                            ...
                                            <a href="{{  route('dashboard.parents.edit',$user->id) }}"
                                            ...
                                            {{-- Show --}}
                                            <a href="{{ route('dashboard.parents.show',$user->id) }}"
